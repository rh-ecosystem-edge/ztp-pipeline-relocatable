...
if ./verify.sh; then
    ...
    RHCOS_ISO="https://mirror.openshift.com/pub/openshift-v4/dependencies/rhcos/pre-release/latest-${OC_OCP_VERSION}/rhcos-live.x86_64.iso"
    RHCOS_ROOTFS="https://mirror.openshift.com/pub/openshift-v4/dependencies/rhcos/pre-release/latest-${OC_OCP_VERSION}/rhcos-live-rootfs.x86_64.img"
