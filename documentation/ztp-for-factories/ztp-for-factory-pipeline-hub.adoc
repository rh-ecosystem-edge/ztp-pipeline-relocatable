...
This is part of ACM which is not deployed by default. Here we configure the way the Edge cluster will eb deployed, certificates, image sources, cluster details, etc...
