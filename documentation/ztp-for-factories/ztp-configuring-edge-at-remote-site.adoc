...
.. Optional: Change the domain name. This will create unique setup and console URLs for your edge cluster.
+
[NOTE]
====
...
.. Clicking on **OpenShift console** button will take you the OpenShift web console of the edge cluster.
