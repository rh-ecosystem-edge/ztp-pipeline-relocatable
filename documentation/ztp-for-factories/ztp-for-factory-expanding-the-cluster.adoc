[id="ztp-for-factory-expanding-the-cluster"]
= Expanding the cluster
include::modules/common-attributes.adoc[]
:context: ztp-for-factory-expanding
...
include::modules/ztp-for-factory-preparing-the-bare-metal-node.adoc[leveloffset=+1]

include::modules/ztp-for-factory-preparing-to-deploy-with-virtual-media-on-the-baremetal-network.adoc[leveloffset=+1]

include::modules/ztp-for-factory-diagnosing-duplicate-mac-address.adoc[leveloffset=+2]

include::modules/ztp-for-factory-provisioning-the-bare-metal-node.adoc[leveloffset=+1]
