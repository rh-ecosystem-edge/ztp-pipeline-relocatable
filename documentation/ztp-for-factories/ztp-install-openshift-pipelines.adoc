...
Follow this guide to install the OpenShift Pipelines Operator that is used to run the pipeline.
...
* Deploys the ZTP pipelines and associated tasks.
...
.. Log in to the {product-title} web console (OPTIONAL).
