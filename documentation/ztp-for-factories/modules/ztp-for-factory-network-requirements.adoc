...
ifdef::upstream[]
For assistance in configuring the DNS server, check xref:ztp-for-factory-upstream-appendix[Appendix] section for:
...
ifdef::upstream[]
For assistance in configuring the DHCP server, check xref:ztp-for-factory-upstream-appendix[Appendix] section for:
