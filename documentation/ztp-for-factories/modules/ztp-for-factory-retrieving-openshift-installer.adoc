...
include::ztp-for-factory-retrieving-openshift-installer-UPSTREAM.adoc[leveloffset=+1]
include::ztp-for-factory-retrieving-openshift-installer-GA.adoc[leveloffset=+1]
...
ifndef::upstream[]
include::ztp-for-factory-retrieving-the-openshift-installer.adoc[leveloffset=+0]
include::ztp-for-factory-extracting-the-openshift-installer.adoc[leveloffset=+0]
