...
include::ztp-for-factory-upstream-select-an-openshift-installer-release-from-ci-development.adoc[leveloffset=+1]
include::ztp-for-factory-upstream-retrieving-the-latest-openshift-installer-development.adoc[leveloffset=+1]
include::ztp-for-factory-upstream-extracting-the-installer-development.adoc[leveloffset=+1]
