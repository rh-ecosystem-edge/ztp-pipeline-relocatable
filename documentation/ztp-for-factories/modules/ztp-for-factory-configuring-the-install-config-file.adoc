...
include::ztp-for-factory-config-yaml.adoc[]
endif::[]
ifeval::[{product-version} == 4.5]
include::ztp-for-factory-config-yaml-4.5.adoc[]
endif::[]
ifeval::[{product-version} == 4.4]
include::ztp-for-factory-config-yaml-4.4.adoc[]
endif::[]
ifeval::[{product-version} <= 4.3]
include::ztp-for-factory-config-yaml-4.3.adoc[]
endif::[]
----
