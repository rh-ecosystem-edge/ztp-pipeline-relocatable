...
//
// installing/installing_bare_metal_ipi/ztp-for-factory-configuration-files
// installing/installing_bare_metal_ipi/ztp-for-factory-post-installation-configuration.adoc
...
ifeval::["{context}" == "ztp-for-factory-configuration-files"]
...
ifeval::["{context}" == "ztp-for-factory-post-installation-configuration"]
