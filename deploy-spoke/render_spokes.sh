...
create_spoke_definitions() {
    ...
    while [ "${RESULT}" != "null" ]; do
        ...
        export JSON_STRING_CFG_OVERRIDE='{"ignition":{"version":"3.1.0"},"storage":{"files":[{"path":"/etc/hosts","append":true,"contents":{"source":"data:text/plain;base64,'${IGN_OVERRIDE_API_HOSTS}'"}}]}}'
