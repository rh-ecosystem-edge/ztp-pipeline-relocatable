...
func (t *CreateTask) createCatalogICSP(ctx context.Context, catalog *unstructured.Unstructured,
...
func (t *CreateTask) generateCatalogICSP(ctx context.Context, catalog *unstructured.Unstructured,
...
func (t *CreateTask) generateIndexICSP(ctx context.Context,
