...
kcli create dns -n bare-net kubeframe-registry-kubeframe-registry.apps.spoke0-cluster.kubeframe.local -i 192.168.150.200
kcli create dns -n bare-net api.spoke0-cluster.kubeframe.local -i 192.168.150.201
